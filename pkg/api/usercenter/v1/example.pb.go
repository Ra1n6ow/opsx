...
// 	protoc        v5.29.4
// source: usercenter/v1/example.proto
...
func (UserStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_usercenter_v1_example_proto_enumTypes[0].Descriptor()
}

func (UserStatus) Type() protoreflect.EnumType {
	return &file_usercenter_v1_example_proto_enumTypes[0]
}
...
func (UserStatus) EnumDescriptor() ([]byte, []int) {
	return file_usercenter_v1_example_proto_rawDescGZIP(), []int{0}
}
...
func (x *ModifierExample) Reset() {
	*x = ModifierExample{}
	mi := &file_usercenter_v1_example_proto_msgTypes[0]
...
var File_usercenter_v1_example_proto protoreflect.FileDescriptor

const file_usercenter_v1_example_proto_rawDesc = "" +
	"\n" +
	"\x1busercenter/v1/example.proto\x12\x02v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbc\x03\n" +
	...
	"\n" +
	"\x06Banned\x10\x02B2Z0github.com/ra1n6ow/opsx/pkg/api/usercenter/v1;v1b\x06proto3"

var (
	file_usercenter_v1_example_proto_rawDescOnce sync.Once
	file_usercenter_v1_example_proto_rawDescData []byte
)

func file_usercenter_v1_example_proto_rawDescGZIP() []byte {
	file_usercenter_v1_example_proto_rawDescOnce.Do(func() {
		file_usercenter_v1_example_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_usercenter_v1_example_proto_rawDesc), len(file_usercenter_v1_example_proto_rawDesc)))
	})
	return file_usercenter_v1_example_proto_rawDescData
}

var file_usercenter_v1_example_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_usercenter_v1_example_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_usercenter_v1_example_proto_goTypes = []any{
	(UserStatus)(0),               // 0: v1.UserStatus
	(*ModifierExample)(nil),       // 1: v1.ModifierExample
	nil,                           // 2: v1.ModifierExample.AddressEntry
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_usercenter_v1_example_proto_depIdxs = []int32{
...
func init() { file_usercenter_v1_example_proto_init() }
func file_usercenter_v1_example_proto_init() {
	if File_usercenter_v1_example_proto != nil {
		return
	}
	file_usercenter_v1_example_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_usercenter_v1_example_proto_rawDesc), len(file_usercenter_v1_example_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_usercenter_v1_example_proto_goTypes,
		DependencyIndexes: file_usercenter_v1_example_proto_depIdxs,
		EnumInfos:         file_usercenter_v1_example_proto_enumTypes,
		MessageInfos:      file_usercenter_v1_example_proto_msgTypes,
	}.Build()
	File_usercenter_v1_example_proto = out.File
	file_usercenter_v1_example_proto_goTypes = nil
	file_usercenter_v1_example_proto_depIdxs = nil
}
